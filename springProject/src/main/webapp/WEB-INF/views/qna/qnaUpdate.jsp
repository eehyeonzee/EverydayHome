...
<div align = "left">
	<h2 class="admin-page-h2">관리자 - 자주묻는질문 수정</h2>
		...
		<div align="center" class = "container-fluid" style = "width:700px; border: 1px solid #d2f1f7; font-family: 'Gowun Dodum', sans-serif; ">
			...
			<!-- 폼 시작 -->
			<form:form id="qnaUpdateForm" action="qnaUpdate.do" modelAttribute="qnaVO">
				<form:hidden path="qna_num"/>
				<div align="left">	
					<span style="font-weight: bold;">문의 번호 : ${qnaVO.qna_num}</span>
				</div>
				...
				<div class = "form-group row">		
					...
					<textarea id="qna_content" name="qna_content" rows="5" cols="30">${qnaVO.qna_content}</textarea>
				</div>
				<div class = "form-group row">		
					<label class = "col-sm-3 col-form-label" for="qna_reply">답변내용</label>
					<textarea id="qna_reply" name="qna_reply" rows="5" cols="30">${qnaVO.qna_reply}</textarea>
				</div>
				<!-- 버튼 -->
