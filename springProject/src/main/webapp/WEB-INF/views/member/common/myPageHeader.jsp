...
<nav class="nav-right">
	...
	<div class="nav-right-menu">
		<ul style="display: inline-block;">
			<li class="navrightmenuli"><a class="navmenuitem" href="${pageContext.request.contextPath}/order/myOrder.do" style="font-size: 20px;text-decoration: none;">나의쇼핑</a>
				<ul class="dropdownbar">
...
<hr size="1" style="color:#bfbfbf; noshade; margin-top:3px;">
<br>
