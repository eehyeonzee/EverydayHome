...
public interface ReviewMapper {
	...
	@Select("SELECT o.prod_num as prod_num, p.prod_name as prod_name, p.prod_option1 as prod_option1, o.order_date as order_date, o.buis_name as buis_name , p.prod_price as prod_price  FROM orders o, product p WHERE  p.prod_num = o.prod_num AND o.mem_num = '1' ORDER BY o.order_date")
