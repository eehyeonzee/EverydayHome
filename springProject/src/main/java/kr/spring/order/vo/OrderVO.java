...
public class OrderVO {
	...
	private int order_detail_num;	// 주문 상세 번호
	private int prod_num;			// 상품 번호
	private int pay_num;			// 결제 번호
	private int pay_quan;			// 결제 수량
	private int pay_price;			// 결제 금액
	private int coupon;				// 쿠폰
	private int point;				// 포인트
	private String buis_name;		// 판매회사명
	private int prod_price;			// 상품 가격
	private String prod_name;		// 상품 이름
	private int delive_price;		// 배송료
	private String delive_type;		// 배송 방법
	private String email;			// 회원정보에 저장된 이메일
	private String phone;			// 회원정보에 저장된 전화번호
	...
	public String toString() {
		return "OrderVO [order_num=" + order_num + ", order_date=" + order_date + ", order_zipcode=" + order_zipcode
